...
function handleEditClick(){
    makeEditable();
    hideButtons();
    var buttomHtml = "<button class=\"btn btn-primary btn-lg\" onclick=\"handleEditSave("+myBook.id+")\">Save</button>"
...
function handleNewClick(){
    ...
    hideButtons();
    blankFields();
    var buttomHtml = "<button class=\"btn btn-primary btn-lg\" onclick=\"handleNewSave()\">Save</button>"
    buttomHtml += "<button class=\"btn btn-warning btn-lg btn-cancle\" onclick=\"handleCancelSave()\">Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttomHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
